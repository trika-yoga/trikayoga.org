...
const meta = {
  ...
  site: "trikayoga.space",
  url: "https://trikayoga.space/", //the end slash here is mandatory
  repo: "https://github.com/trika-yoga/trikayoga.space",
  locale: "en",
  color: '#eeee22',
...
export default defineConfig({
  ...
  markdown: {
    config: (md) => {
      ...
      md.use(mdLinks, {
        internalDomains: ["localhost", "trikayoga.space"],
      });
    },
  },
